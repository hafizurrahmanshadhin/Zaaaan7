...
@section('main')
    <div class="content">
        <h2 class="mb-2 lh-sm">Edit a Sub-Category of Category "{{$category->name}}"</h2>
                ...
                <div class="col-12 col-xl-2">
                    <div class="position-sticky mt-xl-4" style="top: 80px;">
                        ...
                        <ul class="nav nav-vertical flex-column doc-nav" data-doc-nav="data-doc-nav">
                            <li class="nav-item"> <a class="nav-link" href="#save-StockX-credentials">Edit a Sub-Category</a>
                            </li>
                        </ul>
                    </div>
                </div>
